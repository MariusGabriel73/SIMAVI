...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PACIENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PACIENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PACIENT actions', async () => {
      const arg = { id: 10827 };
    ...
    it('dispatches UPDATE_PACIENT actions', async () => {
      const arg = { id: 10827 };
    ...
    it('dispatches PARTIAL_UPDATE_PACIENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PACIENT actions', async () => {
      const arg = 42666;
