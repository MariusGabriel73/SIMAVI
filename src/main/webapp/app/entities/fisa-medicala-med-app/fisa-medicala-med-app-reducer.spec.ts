...
import reducer, {
  ...
  reset,
  updateEntity,
} from './fisa-medicala-med-app.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FISAMEDICALA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FISAMEDICALA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FISAMEDICALA actions', async () => {
      const arg = { id: 395 };
    ...
    it('dispatches UPDATE_FISAMEDICALA actions', async () => {
      const arg = { id: 395 };
    ...
    it('dispatches PARTIAL_UPDATE_FISAMEDICALA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FISAMEDICALA actions', async () => {
      const arg = 42666;
