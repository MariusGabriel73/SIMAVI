...
import reducer, {
  ...
  reset,
  updateEntity,
} from './raport-programare-med-app.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RAPORTPROGRAMARE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RAPORTPROGRAMARE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RAPORTPROGRAMARE actions', async () => {
      const arg = { id: 5477 };
    ...
    it('dispatches UPDATE_RAPORTPROGRAMARE actions', async () => {
      const arg = { id: 5477 };
    ...
    it('dispatches PARTIAL_UPDATE_RAPORTPROGRAMARE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RAPORTPROGRAMARE actions', async () => {
      const arg = 42666;
