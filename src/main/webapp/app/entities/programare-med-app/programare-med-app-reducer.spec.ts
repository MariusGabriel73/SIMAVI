...
import reducer, {
  ...
  reset,
  updateEntity,
} from './programare-med-app.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROGRAMARE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROGRAMARE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROGRAMARE actions', async () => {
      const arg = { id: 13399 };
    ...
    it('dispatches UPDATE_PROGRAMARE actions', async () => {
      const arg = { id: 13399 };
    ...
    it('dispatches PARTIAL_UPDATE_PROGRAMARE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROGRAMARE actions', async () => {
      const arg = 42666;
