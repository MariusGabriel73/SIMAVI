...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEDIC_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEDIC actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEDIC actions', async () => {
      const arg = { id: 10974 };
    ...
    it('dispatches UPDATE_MEDIC actions', async () => {
      const arg = { id: 10974 };
    ...
    it('dispatches PARTIAL_UPDATE_MEDIC actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEDIC actions', async () => {
      const arg = 42666;
