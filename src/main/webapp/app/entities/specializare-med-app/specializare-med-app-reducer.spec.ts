...
import reducer, {
  ...
  reset,
  updateEntity,
} from './specializare-med-app.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPECIALIZARE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPECIALIZARE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPECIALIZARE actions', async () => {
      const arg = { id: 26454 };
    ...
    it('dispatches UPDATE_SPECIALIZARE actions', async () => {
      const arg = { id: 26454 };
    ...
    it('dispatches PARTIAL_UPDATE_SPECIALIZARE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPECIALIZARE actions', async () => {
      const arg = 42666;
