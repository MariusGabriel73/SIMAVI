...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLINICA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLINICA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLINICA actions', async () => {
      const arg = { id: 13966 };
    ...
    it('dispatches UPDATE_CLINICA actions', async () => {
      const arg = { id: 13966 };
    ...
    it('dispatches PARTIAL_UPDATE_CLINICA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLINICA actions', async () => {
      const arg = 42666;
