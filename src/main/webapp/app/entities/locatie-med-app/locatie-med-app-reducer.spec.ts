...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOCATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOCATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOCATIE actions', async () => {
      const arg = { id: 7635 };
    ...
    it('dispatches UPDATE_LOCATIE actions', async () => {
      const arg = { id: 7635 };
    ...
    it('dispatches PARTIAL_UPDATE_LOCATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LOCATIE actions', async () => {
      const arg = 42666;
